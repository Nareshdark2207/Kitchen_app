...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__breakfast__ = __webpack_require__(851);
...
var BreakfastPageModule = /** @class */ (function () {
    ...
    BreakfastPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__breakfast__["a" /* BreakfastPage */]),
            ],
        })
    ], BreakfastPageModule);
...
var BreakfastPage = /** @class */ (function () {
    function BreakfastPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.breakfast = [];
    ...
    BreakfastPage.prototype.ngOnInit = function () {
    ...
    BreakfastPage.prototype.getCartItemCount = function () {
        return this.cartItemCount;
    };
    BreakfastPage.prototype.getTotal = function () {
        return this.totalAmount;
    };
    BreakfastPage.prototype.addFood = function (selectFood) {
        var _this = this;
        this.breakfast.forEach(function (d) {
            if (selectFood.id === d.id) {
                d.quantity = d.quantity + 1;
                if (d.quantity === 1) {
                    _this.addfoods.push(selectFood);
    ...
    BreakfastPage.prototype.removeFood = function (removeFood) {
        var _this = this;
        this.breakfast.forEach(function (r, i) {
            if (removeFood.id === r.id) {
                r.quantity = r.quantity - 1;
                if (r.quantity === 0) {
                    _this.addfoods.forEach(function (el) {
