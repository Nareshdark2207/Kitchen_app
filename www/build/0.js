...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__snacks__ = __webpack_require__(872);
...
var SnacksPageModule = /** @class */ (function () {
    ...
    SnacksPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__snacks__["a" /* SnacksPage */]),
            ],
        })
    ], SnacksPageModule);
 ...
 * Ionic pages and navigation.
 */
var SnacksPage = /** @class */ (function () {
    function SnacksPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.snacks = [];
    ...
    SnacksPage.prototype.getCartItemCount = function () {
        return this.cartItemCount;
    };
    SnacksPage.prototype.getTotal = function () {
        return this.totalAmount;
    };
    SnacksPage.prototype.addFood = function (selectFood) {
        var _this = this;
        this.snacks.forEach(function (d) {
            if (selectFood.id === d.id) {
                d.quantity = d.quantity + 1;
                if (d.quantity === 1) {
                    _this.addfoods.push(selectFood);
    ...
    SnacksPage.prototype.removeFood = function (removeFood) {
        var _this = this;
        this.snacks.forEach(function (r, i) {
            if (removeFood.id === r.id) {
                r.quantity = r.quantity - 1;
                if (r.quantity === 0) {
                    _this.addfoods.forEach(function (el) {
    ...
    SnacksPage.prototype.open_cart = function () {
