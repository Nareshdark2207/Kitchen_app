...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dinner__ = __webpack_require__(859);
...
var DinnerPageModule = /** @class */ (function () {
    ...
    DinnerPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__dinner__["a" /* DinnerPage */]),
            ],
        })
    ], DinnerPageModule);
...
var DinnerPage = /** @class */ (function () {
    function DinnerPage(navCtrl, navParams, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.dinner = [];
    ...
    DinnerPage.prototype.ngOnInit = function () {
    ...
    DinnerPage.prototype.getCartItemCount = function () {
        return this.cartItemCount;
    };
    DinnerPage.prototype.getTotal = function () {
        return this.totalAmount;
    };
    DinnerPage.prototype.addFood = function (selectFood) {
        var _this = this;
        this.dinner.forEach(function (d) {
            if (selectFood.id === d.id) {
                d.quantity = d.quantity + 1;
                if (d.quantity === 1) {
                    _this.addfoods.push(selectFood);
    ...
    DinnerPage.prototype.removeFood = function (removeFood) {
        var _this = this;
        this.dinner.forEach(function (r, i) {
            if (removeFood.id === r.id) {
                r.quantity = r.quantity - 1;
                if (r.quantity === 0) {
                    _this.addfoods.forEach(function (el) {
    ...
    DinnerPage.prototype.open_cart = function () {
